%Connects camera and configurates depth and color streaming
function pipeline=connect(varargin)
    switch nargin
        case 0
            %default values
...
%     saying it wasn't able to resolve...(!)
    ...
    config.enable_stream(realsense.stream.color,0,WIDTH,HEIGHT,realsense.format.rgb8,FPS);
% 
