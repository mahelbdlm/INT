close all;
video= load("jan/save/test28-Nov-2024/video_fast5.mat").video_fast;
tic
fps=video(1).fps;
...
r1=roiframes(:,1:3:end);
r2=roiframes(:,2:3:end);
r3=roiframes(:,3:3:end);
...
%% Result
v=0;
for i=1:length(maxH1(:,1))-1
    v=v+abs(0.14*fps./((find(maxH1(i+1,:)==1)-find(maxH1(i,:)==1))));
end
v=v/i;
figure
plot(v)
