...
%
% P1 and P2 are cells containing the {row=hpos,column=wpos} of the pixels we
%want to measure. 
% 
...
% Check that I is a valid 2D matrix
    [height,width,check_2DMatrix]=size(I);
    if or(isnumeric(I),check_2DMatrix==1)
...
% See 4.4 Depth Field of View at Distance (Z) from the 435i datasheet https://www.intelrealsense.com/download/21345/?tmstv=1697035582
    ...
    dist12y=(HFOV/VFOV)*2*(-depth1*(hpos1-height/2)+depth2*(hpos2-height/2))*tan(HFOV/2)/height;
